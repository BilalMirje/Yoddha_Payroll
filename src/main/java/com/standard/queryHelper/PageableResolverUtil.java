...
public class PageableResolverUtil {
    ...
    public Pageable resolve(com.standard.entity.dtos.pagination.PageRequest pageRequest) {
    ...
    public Sort buildSort(com.standard.entity.dtos.pagination.PageRequest pageRequest) {
    ...
    public boolean hasPage(com.standard.entity.dtos.pagination.PageRequest pageRequest) {
